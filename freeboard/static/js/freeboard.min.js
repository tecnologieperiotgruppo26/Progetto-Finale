...
this.setDefault=function(){freeboard.showDialog("Would you like to replace this dashboard with the default one?","Set Default","Replace","Cancel",
	function(){console.log("{\"version\":1,\"allow_edit\":true,\"plugins\":[],\"panes\":[],\"datasources\":[],\"columns\":3}");$.post("saveDashboard", { json_string: "{\"version\":1,\"allow_edit\":true,\"plugins\":[],\"panes\":[],\"datasources\":[],\"columns\":3}"})})},
